...
async function takeScreenshots() {
    try {
        ...
        await page.setViewport({ width: 1920, height: dasHeight + 800 });
        ...
        // Wait for 3 minutes to ensure the dashboard fully loads
        console.log('Waiting for 3 minutes to ensure the dashboard fully loads...');
        await page.waitForTimeout(180000); // 3 minutes (180,000 milliseconds)
        ...
        // Wait for 3 minutes to ensure the map fully loads
        console.log('Waiting for 3 minutes to ensure the map fully loads...');
        await page.waitForTimeout(180000); // 3 minutes (180,000 milliseconds)
...
// Start the server for any additional functionality (if needed)
app.listen(3000, () => {
